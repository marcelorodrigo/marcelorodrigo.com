...
While this workflow requires more effort than an automatic sync, I've come to appreciate the manual process :thought_balloon:

It gives me a moment to reflect on my ride and develop a deeper connection with my training data. That said, it would be wonderful if Garmin could enhance their integration with Zwift to make this manual process unnecessary.
...
### Bonus Points
Your wourkouts now counts towards Garmin Challenges :sunglasses:

And many thanks to [Kevin Flanagan](https://www.fitfiletools.com/#/about) for developing the mentioned functionality at FitFileTools.